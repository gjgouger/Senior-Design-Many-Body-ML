function [E_min, E_conv, num_kick, time,theo] = grad_descent_adagrad_linear(N, M, L, burn, walks, R, g, hamiltonian, learn_par, learn_func,beta,adambeta1, adambeta2, kick, t, trials, fileID, pbc,exact,w,a,b)
...
axis([1 R -2*N N])
title('Adagrad descent with linear gradient descent')
