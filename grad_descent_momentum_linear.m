function [E_min, E_conv, num_kick, time,theo] = grad_descent_momentum_linear(N, M, L, burn, walks, R, g, hamiltonian, learn_par, learn_func,beta,adambeta1, adambeta2, kick, t, trials, fileID, pbc,exact,w,a,b)
...
[E,grad_a,grad_b,grad_w] = metrohast_linear(a_vec, b_vec, w_mat, L, burn, hamiltonian, g, walks, pbc);
...
[update_a,momentum_a]=momentum(momentum_a, grad_a, beta, learn);
[update_b,momentum_b]=momentum(momentum_b, grad_b, beta, learn);
[update_w,momentum_w]=momentum(momentum_w, grad_w, beta, learn);
...
axis([1 R -2*N N])
title('Momentum descent with linear gradient descent')
