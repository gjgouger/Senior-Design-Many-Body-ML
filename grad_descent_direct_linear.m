function [E_min, E_conv, num_kick, time,theo] = grad_descent_direct_linear(N, M, L, burn, walks, R, g, hamiltonian, learn_par, learn_func,beta,adambeta1, adambeta2, kick, t, trials, fileID, pbc,exact,w,a,b)
...
a_vec = (a_vec) - (grad_a)*learn;
b_vec = (b_vec) - (grad_b)*learn;
w_mat = (w_mat) - (grad_w)*learn;
...
axis([1 R -2*N N])
title('direct descent with linear gradient descent')
