function [E, grad_a, grad_b, grad_w] = metrohast_linear(a_vec, b_vec, w_mat, L, burn, hamiltonian, g, walks, pbc)
...
% Calculate gradients
grad_a = ((o_a_e) - conj(o_a)*(E)); %make on gpu
grad_b = ((o_b_e) - conj(o_b)*(E));
grad_w = ((o_w_e) - conj(o_w)*(E));
